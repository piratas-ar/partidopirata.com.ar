...
Con el nuevo modelo, de dato abundantes,  se acumulan primero y se pregunta después. El <em>esquema se produce</em> después de la recolección. De hecho, historias de éxito, sobre Grandes Datos,  como Splunk, Palantir, y otras son muy apreciadas por su capacidad para entender el contenido después de que se han recogido-a veces llamado un esquema de consulta menor. Esto significa que recopilamos la información mucho antes de decidir para que es.

Y esto es una cosa peligrosa.
...
En un caso, American Express utiliza el historial de compras para ajustar los límites de crédito sobre la basado en donde un cliente compras, a pesar de su excelente  límite de crédito.
<p style="text-align: center;"> "Johnson se quedó con la boca abierta al leer una de las razones que le dieron a American Express para reducir su límite de crédito: ". Otros clientes usaron su tarjeta en los establecimientos en los que recientemente compró tienen un deficiente historial de pagos con American Express"</p>
Estamos viendo el comienzo de una pendiente resbaladiza por todas partes desde <a href="http://www.nytimes.com/2012/02/05/opinion/sunday/facebook-is-using-you.html" target="_blank"> los límites a medida de las tarjetas de crédito</a> como el anterior a<a href="http://www.progressive.com/auto/snapshot.aspx" target="_blank">un seguro de autos basado en perfiles del conductor</a> . En este sentido, los grandes datos es un asunto de derechos civiles, pero en general la sociedad está mal equipada para hacerle frente.

<em>Now run this backwards</em>.<em> </em>If I know you like these things, or see you mention them in blog posts, on Facebook, or in tweets, then there’s a good chance I know your gender and your race, and maybe even your religion and your sexual orientation. And that I can personalize my marketing efforts towards you.

Ahora ejecútalo al revés. Si sé que te gustan estas cosas, o mirá que  mencionás en blogs, en Facebook, o en los tweets, entonces hay una buena probabilidad de que sepa tu sexo y tu raza, y tal vez incluso tu religión y tu orientación sexual. Y que puedo personalizar mis esfuerzos de marketing hacia ti.

Eso hace que sea un asunto de derechos civiles.

Si recopilo información sobre la música que escuchás, puedes asumir que voy a utilizar esos datos para sugerirte nuevas canciones, o compartirla con tus amigos. Pero en cambio,  podría utilizarla para adivinar tu origen racial. Y entonces yo podría utilizar esos datos para negarte un préstamo.
